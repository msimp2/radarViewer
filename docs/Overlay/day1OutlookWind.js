let day1WindLayer = null;

export async function addDay1OutlookWindLayer(map) {
    const url = 'https://www.spc.noaa.gov/products/outlook/day1otlk_wind.lyr.geojson';
    ...
    day1WindLayer = L.geoJSON(geojson, { style, onEachFeature }).addTo(map);
}

export function removeDay1OutlookWindLayer(map) {
    if (day1WindLayer) {
        map.removeLayer(day1WindLayer);
        day1WindLayer = null;
    }
}